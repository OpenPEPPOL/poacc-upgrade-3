...
[indent=0]
----
    [source, xml, indent=0] <1>
    ----
    include::snippets/snippet-01.xml[tags=price]<2>
    ----
----

<1> Setting source to xml, and also setting indent to 0, allowing the leading block indent to be stripped
