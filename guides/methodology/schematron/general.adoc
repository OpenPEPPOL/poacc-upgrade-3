...
Different patterns should be provided, suggestion is to have 3 different patterns:
...
Functions can be created to do checking of format/pattern of values, example is to check that the GLN number has a correct format/pattern, as seen below.
