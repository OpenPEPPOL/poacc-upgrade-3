...
In the example a seller confirms the first line of an order, provides two delivery dates for second order line of 3 pcs of Product B by adding a new line and then confirms that order line 3 has already been delivered.

.Example of adding lines and delivering over time:
[source, xml, indent=0]
----
include::../snippets/snippet-1.xml[tags=line-change5]
----
