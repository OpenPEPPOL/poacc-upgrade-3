...
Prices may be exchanged in the order only both for products with or without item identifiers and free text orders.
...
* Prices should include allowances and/or charges but exclude VAT amounts
