...
[source, xml, indent=0]
----
include::../snippets/snippet-01.xml[tags=seller]
----
...
[source, xml, indent=0]
----
include::../snippets/snippet-01.xml[tags=buyer]
----
...
[source, xml, indent=0]
----
include::../snippets/snippet-01.xml[tags=originator]
----
...
[source, xml, indent=0]
----
include::../snippets/snippet-01.xml[tags=invoicee]
----
