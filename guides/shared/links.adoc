...
//examples
:order-UC: https://github.com/OpenPEPPOL/poacc-upgrade-3/tree/master/guides/rules/use-case-examples/order/examples[Use case example files]
:order-response-UC: https://github.com/OpenPEPPOL/poacc-upgrade-3/tree/master/guides/rules/use-case-examples/order-response/examples[Use case example files]
