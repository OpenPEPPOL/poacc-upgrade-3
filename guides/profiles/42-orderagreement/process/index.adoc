...
include::../../../shared/bpmn/bpmn-legend.adoc[align = "center", width=600]

:leveloffset: -1

The following diagram shows the choreography of the business process implemented by the BIS.

image:../images/bpmn-orderagreement1.jpg[align = "center", width=600]

image:../images/bpmn-orderagreement2.jpg[align = "center", width=600]
