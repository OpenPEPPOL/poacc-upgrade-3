...
A shopping cart line may give information about the classification of items

.Example of classification code
[source, xml, indent=0]
----
include::../snippets/snippet-18-1.xml[tags=classification]
----
...
[source, xml, indent=0]
----
include::../snippets/snippet-18-1.xml[tags=label]
----
