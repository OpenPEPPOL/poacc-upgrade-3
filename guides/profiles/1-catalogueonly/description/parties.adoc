...
[source, xml, indent=0]
----
include::../snippets/snippet-1-1.xml[tags=seller]
----
...
[source, xml, indent=0]
----
include::../snippets/snippet-1-1.xml[tags=buyer]
----
...
[source, xml, indent=0]
----
include::../snippets/snippet-1-1.xml[tags=supplier]
----
...
[source, xml, indent=0]
----
include::../snippets/snippet-1-1.xml[tags=contractor]
----
...
[source, xml, indent=0]
----
include::../snippets/snippet-1-1.xml[tags=manufacturer]
----
