...
:advanced_ordering_sc1: https://github.com/OpenPEPPOL/POAC-Advanced-Ordering/tree/main/rules/use-case-examples/advanced_ordering_sc1[Example files scenario 1]
:advanced_ordering_sc2: https://github.com/OpenPEPPOL/POAC-Advanced-Ordering/tree/main/rules/use-case-examples/advanced_ordering_sc2[Example files scenario 2]
:advanced_ordering_sc3: https://github.com/OpenPEPPOL/POAC-Advanced-Ordering/tree/main/rules/use-case-examples/advanced_ordering_sc3[Example files scenario 3]
:advanced_ordering_sc4: https://github.com/OpenPEPPOL/POAC-Advanced-Ordering/tree/main/rules/use-case-examples/advanced_ordering_sc4[Example files scenario 4]
:advanced_ordering_sc5: https://github.com/OpenPEPPOL/POAC-Advanced-Ordering/tree/main/rules/use-case-examples/advanced_ordering_sc5[Example files scenario 5]
