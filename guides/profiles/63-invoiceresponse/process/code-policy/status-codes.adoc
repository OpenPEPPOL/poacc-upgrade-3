...
|PD and PPD |Partially Paid |Indicates that the referenced document or transaction has been partially paid. |Status is used only when the Buyer has initiated the payment of the invoice without having paid the accepted amount in full. |NO |NO |NO |NO
|====
