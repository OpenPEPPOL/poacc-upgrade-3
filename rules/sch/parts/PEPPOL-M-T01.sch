    ...
    <schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:u="utils" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <pattern>       
            ...
            <rule context="cac:AnticipatedMonetaryTotal">
                ...
                <!-- New rules to ensure correct calculation, based on similar rules in EN16931-->
            ...
            <rule context="cac:OrderLine/cac:LineItem"> 
                ...
                <assert id="PEPPOL-T01-R024"  
                    ...
                    flag="fatal">Order line net amount MUST equal (Ordered quantity * (Item net price/item price base quantity) + Ordr line charge amount - Order line allowance amount</assert>
