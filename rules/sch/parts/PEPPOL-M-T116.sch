...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
   ...
   <rule context="ubl:OrderResponse">
       <assert  id="PEPPOL-T116-R007"
               test="(exists(cac:PromisedDeliveryPeriod/cbc:StartDate) and exists(cac:OrderLine/cac:LineItem/cac:PromisedDeliveryPeriod/cbc:StartDate)"
               flag="fatal">Promised Delivery Period shall be defined either on document level or on line level. </assert>
   </rule>
