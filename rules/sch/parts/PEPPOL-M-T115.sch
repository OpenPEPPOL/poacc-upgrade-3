...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <rule context="cbc:ProfileID">
        <assert id="PEPPOL-T115-R031"
            ...
            flag="fatal">An order cancellation transaction SHALL use profile advanced_ordering.</assert>
    </rule>

		<rule context="cbc:CustomizationID">
				<assert id="PEPPOL-T115-R034"
						test="starts-with(normalize-space(.), 'urn:fdc:peppol.eu:poacc:trns:order_cancellation:3')"
						flag="fatal">Specification identifier SHALL start with the value 'urn:fdc:peppol.eu:poacc:trns:order_cancellation:3'.</assert>
		</rule>
